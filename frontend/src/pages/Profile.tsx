  ...
  return (
    <div className="px-6 py-10">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <p className="mt-2 text-sm text-[#6a5f52]">ローカルに保存されているセッション情報です。</p>

        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-[#eadfce] bg-white p-6 shadow-sm">
            <div className="text-xs uppercase tracking-[0.3em] text-[#b06c4a]">User</div>
            <div className="mt-4 text-2xl font-display text-[#2b2620]">{username}</div>
            <div className="mt-2 text-sm text-[#6a5f52]">ID: {userId}</div>
          </div>
          <div className="rounded-2xl border border-[#eadfce] bg-white p-6 shadow-sm">
            <div className="text-xs uppercase tracking-[0.3em] text-[#b06c4a]">Token</div>
